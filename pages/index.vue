<template>
  <div>
    ...
    <Card
      ...
      src="topics/gishohaku13"
      title="「第13回 技術書同人誌博覧会」に出展します!!"
      description="2026年5月10日 (日) 開催「第13回 技術書同人誌博覧会」にて、新刊含む技術書とWindows 11対応のPCゲームを頒布します! 場所は大田区産業プラザPiO 大展示ホール「さ01」です。ぜひお越しください!!"
      height-auto
    />
    <Card
